/* Author: kmmcelro
# This is my solution to the Hackerrank challenge, Connecting Towns
...
The number of roads from city0  to city 1 is the first value in the array, from city 1 to city 2 is the second, and so on.
...
int connectingTowns(int n, vector<int> routes) {
    int routesN = 1;
    for(int route : routes){ // looping over vector to find the # of combinations
        routesN = (routesN * route) % 1234567;
    }
    return routesN;
